...
**Module:** `3_pavitra_scene_service/`  
...
All models are defined in [`satellite/models.py`](file:///d:/SIH/AIS-SAR-OilSpill-Vessel-Attribution/3_pavitra_scene_service/satellite/models.py) using Pydantic v2:
...
1. **`LOCAL CACHE` (Offline-First):** Checks [`LocalSceneCache`](file:///d:/SIH/AIS-SAR-OilSpill-Vessel-Attribution/3_pavitra_scene_service/satellite/cache.py). If valid metadata and raster with matching SHA-256 exist on disk, returns immediately (`source_provider="CACHE"`).
...
- Located at: `3_pavitra_scene_service/fixtures/demo_scene/`
- Contains:
...
2. **Downstream Consumption by Detection Engine:**
   - The downstream detection pipeline (e.g. `1_indhu_main_system/backend/services/detection/detector.py` or `2_nandha_engines/`) reads `geotiff_path` to perform SAR segmentation, feature extraction, and oil slick classification.
...
|---|---|---|---|
| [`test_models.py`](file:///d:/SIH/AIS-SAR-OilSpill-Vessel-Attribution/3_pavitra_scene_service/tests/test_models.py) | Phase 1 (Data Models) | 12 | **PASS** |
| [`test_cache.py`](file:///d:/SIH/AIS-SAR-OilSpill-Vessel-Attribution/3_pavitra_scene_service/tests/test_cache.py) | Phase 2 (Local Cache) | 14 | **PASS** |
| [`test_cdse_adapter.py`](file:///d:/SIH/AIS-SAR-OilSpill-Vessel-Attribution/3_pavitra_scene_service/tests/test_cdse_adapter.py) | Phase 3 (CDSE Adapter) | 14 | **PASS** |
| [`test_asf_adapter.py`](file:///d:/SIH/AIS-SAR-OilSpill-Vessel-Attribution/3_pavitra_scene_service/tests/test_asf_adapter.py) | Phase 4 (ASF Adapter) | 15 | **PASS** |
| [`test_chain.py`](file:///d:/SIH/AIS-SAR-OilSpill-Vessel-Attribution/3_pavitra_scene_service/tests/test_chain.py) | Phase 5 (Fallback Chain) | 12 | **PASS** |
| [`test_status.py`](file:///d:/SIH/AIS-SAR-OilSpill-Vessel-Attribution/3_pavitra_scene_service/tests/test_status.py) | Phase 6 (Provider Status) | 14 | **PASS** |
| [`test_cli.py`](file:///d:/SIH/AIS-SAR-OilSpill-Vessel-Attribution/3_pavitra_scene_service/tests/test_cli.py) | Phase 7 (CLI Interface) | 14 | **PASS** |
| [`test_demo_fixture.py`](file:///d:/SIH/AIS-SAR-OilSpill-Vessel-Attribution/3_pavitra_scene_service/tests/test_demo_fixture.py) | Phase 8 (Demo Fixtures) | 14 | **PASS** |
| [`test_end_to_end.py`](file:///d:/SIH/AIS-SAR-OilSpill-Vessel-Attribution/3_pavitra_scene_service/tests/test_end_to_end.py) | Phase 9A (End-to-End Validation) | 9 | **PASS** |
| **Total Test Suite** | **Phases 1–9A** | **118 / 118** | **100% PASS** |

### Running Tests
```bash
# Run complete test suite
python -m unittest discover -s 3_pavitra_scene_service/tests -v

# Run end-to-end integration tests
python -m unittest 3_pavitra_scene_service/tests/test_end_to_end.py -v
```
...
- **Module Boundary:** Strictly preserved (0 modifications outside `3_pavitra_scene_service/`).
