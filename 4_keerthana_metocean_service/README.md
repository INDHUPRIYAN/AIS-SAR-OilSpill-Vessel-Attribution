...
Downstream Consumer: **Nandha's Drift Engine** (`2_nandha_engines/`) for Euler integration and OpenDrift trajectory simulations.
...
python 4_keerthana_metocean_service/metocean/cli.py \
...
python 4_keerthana_metocean_service/metocean/cli.py --health-check
```
...
```bash
python -m unittest discover -s 4_keerthana_metocean_service/tests -p "test_*.py"
```
